...
def data_loader(y_cols: List[str], x_cols_to_exclude: List[str]):
    ...
    with warnings.catch_warnings():
        ...
        #cbcl_df = pd.read_csv(path + "abcd_cbcls01.txt", delim_whitespace=True).drop(0)
        cbcl_df = cbcl_df[merge_cols + cbcl_cols]
        
        cbcl_item_df = pd.read_csv(path + "abcd_cbcl01.txt", delim_whitespace=True).drop(0)
        #cbcl_item_df = cbcl_item_df[cbcl_item_df.eventname == 'baseline_year_1_arm_1']
        cbcl_item_df = cbcl_item_df[merge_cols + cbcl_item_cols]
        #cbcl_item_df['eventname'] = 'baseline_year_1_arm_1'
        ...
        #sleep_df = sleep_df[sleep_df['eventname'] == 'baseline_year_1_arm_1']
        #sleep_df = sleep_df[sleep_df['eventname'] == '2_year_follow_up_y_arm_1']
        #sleep_df['eventname'] = 'baseline_year_1_arm_1'
        ...
        #bmi_df = bmi_df[bmi_df['eventname'] == "baseline_year_1_arm_1"]
        ...
        #screen_df = screen_df[screen_df['eventname'] == 'baseline_year_1_arm_1']
        ...
        #bpmt_df = bpmt_df[bpmt_df['eventname'] == "baseline_year_1_arm_1"]
    ...
    #missing_vals = []
    #for c in pred_vars + y_cols:
    #    missing_vals.append((c, master_df[c].isna().sum()))
    #print(sorted(missing_vals,  key=lambda x:x[0]))
